...
products$CAP.LETTES <- regmatches(products$NombreProducto, 
...
#[1] "character(0)"    "g"      "Kg"     "ml"        "kg"     "c(\"g\", \"g\")"
#[7] "gProm"
...
nrow(products[which(products$Weights.measure == "character(0)"),])
# [1] 64 !!!!! What are they?
products[which(products$Weights.measure == "character(0)"),]

#### PLAY MORE WITH REGEXP!!